...
plt.savefig('plots_paper/fig2.png',dpi=150)



fig = plt.figure(figsize=(7, 5))

dat=ascii.read('data/scatter/scatter-s34-parts.csv')
...
plt.savefig('plots_paper/fig3.png',dpi=150)
...
dat2=ascii.read('data/scatter/scatter-2min-qflags.csv')
